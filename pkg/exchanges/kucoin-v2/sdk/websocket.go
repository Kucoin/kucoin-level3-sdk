...
func (kucoin *Kucoin) WebSocketPrivateToken() (*WebSocketTokenModel, error) {
	resp, err := kucoin.httpClient.Request(http.MethodPost, "/api/v1/bullet-private", nil)
	if err != nil {
		return nil, err
	}
...
func (kucoin *Kucoin) WebSocketPublicToken() (*WebSocketTokenModel, error) {
	resp, err := kucoin.httpClient.Request(http.MethodPost, "/api/v1/bullet-public", nil)
	if err != nil {
		return nil, err
	}
...
func (kucoin *Kucoin) NewWebSocketClient(token *WebSocketTokenModel) *WebSocketClient {
	wc := &WebSocketClient{
		wg:            &sync.WaitGroup{},
